...
> **Product identity (2026-07-17, operator decision).** The operator-facing product formed by bridge (runtime) + crew (console) is named **Missionroom** (missionroom.ai): where you charter teams, give them missions, and see how they are getting on. **Engram Labs** is the company/umbrella brand; engram-studio remains the engram platform feeding the fleet; **Deskpoint** is reserved for the future packaged PA-team offering. The rename is display-and-packaging only (no wire/enum/hashed change). The full decision record, vocabulary (teams, charters, seats, missions, rooms), legal posture and phased plan live in [`docs/missionroom-plan.md`](../../docs/missionroom-plan.md) — the single master this PVD traces (PG5, PF0012–PF0014). Anchors: crew RFC-0022/0023/0024, bridge RFC-0023.
...
| PG5 | **Missionroom v1 live** — the chartered-team delivery product under the new name | an evidence-gated mission delivered end-to-end by a chartered, identity-staffed team (`verify_ac`-gated Done + identity-bound review) | 1 mission | crew + bridge | Proposed (plan: [`docs/missionroom-plan.md`](../../docs/missionroom-plan.md)) |
...
| PF0012 | **Missionroom rebrand programme** — display-only rename (product name, crews→teams, /work→missions, repo/GHCR mechanics; wire/enums untouched) | crew + bridge | crew:RFC-0024 | P1 | Proposed | plan Phase 1 |
| PF0013 | **Missions consume the sdlc-studio artefact contract** — stories as task contracts, `verify_ac` completion, evidence write-back, mission-log steer wake | crew | crew:RFC-0022 | P1 | Proposed | plan Phases 2–3 |
| PF0014 | **Team charters + bridge enforcement** — charter-as-data, staffing flow, per-seat memory write-ACLs, identity-bound author≠reviewer | crew + bridge | crew:RFC-0023 · bridge:RFC-0023 | P1 | Proposed | plan Phase 4 |
...
| 2026-07-17 | **Product identity settled — the operator-facing bridge+crew product is named Missionroom** (missionroom.ai): charter teams, give them missions, watch progress. Engram Labs stays the company/umbrella brand; engram-studio stays the engram platform; Deskpoint is reserved for the future packaged PA-team offering. Rename is display-and-packaging only — no wire/enum/hashed change. Single master: `docs/missionroom-plan.md` (decision record + vocabulary + six-phase plan). | operator | §1 product-identity, PG5, PF0012–PF0014, `docs/missionroom-plan.md`; crew RFC-0022/0023/0024, bridge RFC-0023 |
...
| 2026-07-17 | 0.7.0 | **Product identity settled — Missionroom.** The operator-facing bridge+crew product is named Missionroom (missionroom.ai); Engram Labs is the umbrella brand, Deskpoint reserved for the future PA-team offering. Added the §1 product-identity note, PG5 (Missionroom v1 live) and PF0012–PF0014 (rebrand programme · missions-as-contracts · team charters + bridge enforcement), tracing crew RFC-0022/0023/0024 + bridge RFC-0023. Single master: `docs/missionroom-plan.md`. Manifest notes the pending in-place bridge/crew renames. Display-and-packaging only — no wire/enum/hashed change. | Claude (Opus 4.8) |
