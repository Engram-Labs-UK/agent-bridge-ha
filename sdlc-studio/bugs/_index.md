...
| [BG0012](BG0012-streaming-leaks-confirm-marker.md) | Streaming path speaks the `[confirm:LEVEL]` marker aloud + stores it unstripped in ChatLog | Medium | P2 | Fixed | conversation.py |
